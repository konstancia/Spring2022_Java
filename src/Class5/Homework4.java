...
public class Homework4 {
    public static void main(String[] args) {
        ...
        String statement = "Konstancia";

        boolean isContains_a= statement.contains("a");
        System.out.println("\nis contains 'a' in '" + statement + "' -> " + isContains_a);
        ...
        boolean isContains_king= task3.contains("king");
        System.out.println("\nis contains 'king' in '" + task3 + "' -> " + isContains_king);
